...
<html>
    ...
    <body>
        ...
        <div id="div_option" >
            ...
            <div id="ss" class="FunctionControl" style="position: absolute; z-index:2; left: 380px; width: 130px; height: 30px; text-align:center; line-height:25px; font-size: larger;" onmouseover="mouseon_b('ss');" onmouseout="mouseout_b('ss');">
            ...
            <div id="lo" class="FunctionControl" style="position: absolute; z-index:2; left: 790px; width: 100px; height: 30px; text-align:center; line-height:25px; font-size: larger;" onmouseover="mouseon_b('lo');" onmouseout="mouseout_b('lo');" onclick='window.location="/ui/Logout.html"'>
